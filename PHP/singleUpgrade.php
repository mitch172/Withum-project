        ...
        <form action="updateUpgrade.php" method="get">
            ...
            ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <select name='buildLocation'>
                                        <option value='BOS' <?php if($buildLocation == 'BOS') echo "selected:selected"; ?>>Boston</option>
                                        <option value='BRT' <?php if($buildLocation == 'BRT') echo "selected:selected"; ?>>Braintree</option>
                                        <option value='CAR' <?php if($buildLocation == 'CAR') echo "selected:selected"; ?>>Carlsbad</option>
                                        <option value='DC' <?php if($buildLocation == 'DC') echo "selected:selected"; ?>>DC</option>
                                        <option value='EB' <?php if($buildLocation == 'EB') echo "selected:selected"; ?>>East Brunswick</option>
                                        <option value='ENC' <?php if($buildLocation == 'ENC') echo "selected:selected"; ?>>Encino</option>
                                        <option value='IRV' <?php if($buildLocation == 'IRV') echo "selected:selected"; ?>>Irvine</option>
                                        <option value='NAS' <?php if($buildLocation == 'NAS') echo "selected:selected"; ?>>Nashville</option>
                                        <option value='NYC' <?php if($buildLocation == 'NYC') echo "selected:selected"; ?>>New York</option>
                                        <option value='ORL' <?php if($buildLocation == 'ORL') echo "selected:selected"; ?>>Orlando</option>
                                        <option value='PHI' <?php if($buildLocation == 'PHI') echo "selected:selected"; ?>>Philadelphia</option>
                                        <option value='POR' <?php if($buildLocation == 'POR') echo "selected:selected"; ?>>Portland</option>
                                        <option value='PRI' <?php if($buildLocation == 'PRI') echo "selected:selected"; ?>>Princeton</option>
                                        <option value='PRO' <?php if($buildLocation == 'PRO') echo "selected:selected"; ?>>Providence</option>
                                        <option value='RB' <?php if($buildLocation == 'RB') echo "selected:selected"; ?>>Red Bank</option>
                                        <option value='SB' <?php if($buildLocation == 'SB') echo "selected:selected"; ?>>Saddle Brooke</option>
                                        <option value='SF' <?php if($buildLocation == 'SF') echo "selected:selected"; ?>>San Francisco</option>
                                        <option value='SAR' <?php if($buildLocation == 'SAR') echo "selected:selected"; ?>>San Ramon</option>
                                        <option value='SEA' <?php if($buildLocation == 'SEA') echo "selected:selected"; ?>>Seattle</option>
                                        <option value='WHI' <?php if($buildLocation == 'WHI') echo "selected:selected"; ?>>Whippany</option>
                                        <option value='WOB' <?php if($buildLocation == 'WOB') echo "selected:selected"; ?>>Woburn</option>
                                        <option value='REM' <?php if($buildLocation == 'REM') echo "selected:selected"; ?>>Remote</option>
                                    </select>
                                </td>
                            </tr>
            <?php
